package com.hyk.app.ipclearndemo.socket;
...
public class TCPClientActivity extends Activity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_RECEIVE_NEW_MSG:
                    mMessageTextView.setText(String.format("%s%s", String.valueOf(mMessageTextView.getText()), msg.obj));
                    break;
    ...
    private void connectTCPServer() {
        ...
        while (socket == null) {
            try {
                socket = new Socket("192.168.0.108", 8688);
